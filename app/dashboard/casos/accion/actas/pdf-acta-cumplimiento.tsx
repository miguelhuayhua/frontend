                    ...
                    dom.children.forEach((child: any) => {
                        if (child.type == 'text') {
                            ...
                            if (child.name == 'strong') {
                                ...
                                else if (child.children[0].data == 'under-CUM') {
                                    listaP.push(<Text key={dom.type + index} style={styles.textBold} >
...
const ActaCumplimiento = (props: Props) => {
        ...
        <Document>
            <Page style={styles.page}>
                ...
                <View style={{ marginTop: 80, padding: 10 }}>
                    ...
                    <Text style={{ ...styles.title, marginVertical: 10 }}>ACTA DE CUMPLIMIENTO</Text>
...
export default ActaCumplimiento;
