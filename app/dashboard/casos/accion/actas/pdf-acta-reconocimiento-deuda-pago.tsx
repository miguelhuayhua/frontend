...
const ActaReconomientoDeudaPago = (props: Props) => {
    return (
        <Document>
            <Page style={styles.page}>
                ...
                <View style={{ marginTop: 80, padding: 10 }}>
                    ...
                    <Text style={{ ...styles.title, marginVertical: 10 }}>ACTA DE RECONOCIMIENTO DE DEUDA Y COMPROMISO DE PAGO</Text>
...
export default ActaReconomientoDeudaPago;
