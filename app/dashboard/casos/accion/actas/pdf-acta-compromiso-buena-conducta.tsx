...
const ActaCompromisoBuenaConducta = (props: Props) => {
        ...
        <Document>
            <Page style={styles.page}>
                ...
                <View style={{ marginTop: 80, padding: 10 }}>
                    ...
                    <Text style={{ ...styles.title, marginVertical: 10 }}>ACTA DE COMPROMISO Y BUENA CONDUCTA</Text>
...
export default ActaCompromisoBuenaConducta;
